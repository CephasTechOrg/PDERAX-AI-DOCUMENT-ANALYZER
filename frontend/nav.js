...
(function () {
    ...
    const inFrontend  = pathname.includes('/frontend/');
    const root        = inFrontend ? '../' : '';
    const fe          = inFrontend ? ''    : 'frontend/';
    ...
    /* ── Nav links ──────────────────────────────────────────────── */
    const NAV_LINKS = [
        { label: 'Analyzer',     href: `${root}index.html`,        file: 'index.html'        },
        { label: 'AI Assistant', href: `${fe}ai-assistant.html`,   file: 'ai-assistant.html' },
        { label: 'Study Tools',  href: `${fe}study-tools.html`,    file: 'study-tools.html'  },
        { label: 'History',      href: `${fe}history.html`,        file: 'history.html'      },
        { label: 'Pricing',      href: `${fe}pricing.html`,        file: 'pricing.html'      },
    ];
