...
function resolveBaseURL() {
    ...
    // Live Server or local development detection
    const isLocal =
        host === 'localhost' ||
        host === '127.0.0.1' ||
        host === '0.0.0.0' ||
        port === '5500' ||  // Live Server default
        port === '5501' ||  // Live Server alternate
        port === '5502' ||  // Live Server alternate
...
class APIService {
    ...
    async uploadAndAnalyze(file) {
        ...
        console.log('[API] Detected base URL:', this.baseURL);
